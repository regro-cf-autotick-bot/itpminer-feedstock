...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itpminer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13672&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itpminer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itpminer` can be installed with:

```
conda install itpminer
```

It is possible to list all of the versions of `itpminer` available on your platform with:
